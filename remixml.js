...
(function(W, D, O) {
  ...
  function insert(j, quot, fmt, $) {
    if ((j = fvar(j, $)) != null) {
      ...
      switch (quot) {
        case "json": j = JSON.stringify(j);
          break;
        case "uric": j = j.replace(/[+ ?&#]/g, eumap);
          break;
        ...
        do {
          ...
          if (j.nodeType) {
            if (!s.lastChild) {
              ...
              (s = D.createDocumentFragment()).appendChild(c);
            }
            s.appendChild(j); j = "";
          }
          if (j += i.shift())
...
keep:     switch (j) {
  ...
  if (W.exports)
    W.exports.Remixml = Remixml, W.exports.document = D;

})(typeof window == "object" ? window : global,
   typeof document == "object" ? document : require("minidom")(''),
   Object);
