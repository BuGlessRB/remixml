...
var pre =
  '(function() { var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {}; templates[%NAME%] = template('
var post = ');})();'
...
module.exports = {
  ...
  compile: function (src, templatePath, templateName, callback) {
    ...
    compiled =
      pre.replace(/%NAME%/, JSON.stringify(templateName)) + compiled + post
